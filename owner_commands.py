...
def owner_keyboard():
    return ReplyKeyboardMarkup(
        keyboard=[
            ...
            [KeyboardButton(text="🤖 ИИ-анализ дня"),  KeyboardButton(text="🏆 Конкуренты")],
...
@router.message(F.text == "🏆 Конкуренты", is_owner)
async def competitors(message: Message):
    ...
    await message.answer(f"💡 *Рекомендации ИИ*\n\n{result}", parse_mode="Markdown")
